...
public class ItemControllerTest {
    ...
    public void getAllItems() {
        client.get().uri(ItemConstants.ITEMS_END_POINT)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getAllItems_approach3() {
        Flux<Item> flux = client.get().uri(ItemConstants.ITEMS_END_POINT)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON_UTF8)
    ...
    public void getOneItem_notFound() {
        client.get().uri(ItemConstants.ITEMS_END_POINT.concat("/{id}"), "DEF")
                .exchange()
    ...
    public void createItem() {
        ...
        client.post().uri(ItemConstants.ITEMS_END_POINT)
    ...
    public void deleteItem() {
        client.delete().uri(ItemConstants.ITEMS_END_POINT.concat("/{id}"), "ABC")
    ...
    public void updateItem() {
        ...
        client.put().uri(ItemConstants.ITEMS_END_POINT.concat("/{id}"), "ABC")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .body(Mono.just(item), Item.class)
                .exchange()
    ...
    public void updateItem_notFound() {
        ...
        client.put().uri(ItemConstants.ITEMS_END_POINT.concat("/{id}"), "DEF")
                .contentType(MediaType.APPLICATION_JSON_UTF8)
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .body(Mono.just(item), Item.class)
                .exchange()
